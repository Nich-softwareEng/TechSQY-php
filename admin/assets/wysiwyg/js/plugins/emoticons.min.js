...
!(function (e, c) {
  "object" == typeof exports && "undefined" != typeof module
    ? c(require("froala-editor"))
    : "function" == typeof define && define.amd
    ? define(["froala-editor"], c)
    : c(e.FroalaEditor);
})(this, function (S) {
  "use strict";
  (S = S && S.hasOwnProperty("default") ? S["default"] : S),
    Object.assign(S.POPUP_TEMPLATES, {
    ...
    (S.PLUGINS.emoticons = function (m) {
                ...
                (function d(e, o) {
                  ...
                  return (
                    e.forEach(function (e) {
                      var c = { image: e.code.toLowerCase() },
                        d = {
                          elementClass:
                            e.id === o.id ? "fr-active fr-active-tab" : "",
                      ...
                      a += '<button class="fr-command fr-btn '
                        .concat(d.elementClass, " ")
                        .concat(d.emoticonsUnicodeClass, '" \n      title="')
                        .concat(d.title, '" data-cmd="')
                        .concat(d.dataCmd, '" data-param1="')
                        .concat(d.dataParam1, '">\n       ')
      ...
      return {
        _init: function e() {
          var d = function d() {
            for (
              ...
              e[c].className += " fr-deletable";
          };
          d(),
            m.events.on("html.set", d),
            m.events.on("keydown", function (e) {
              if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                var c = m.selection.ranges(0),
                  d = i();
                m.node.hasClass(d, "fr-emoticon-img") &&
                  d &&
                  (0 === c.startOffset && m.selection.element() === d
                    ? C(d).before(S.MARKERS + S.INVISIBLE_SPACE)
                    : C(d).after(S.INVISIBLE_SPACE + S.MARKERS),
                  m.selection.restore());
              }
            }),
            m.events.on("keyup", function (e) {
              for (
                var c = m.el.querySelectorAll(".fr-emoticon"), d = 0;
                d < c.length;
                d++
              )
                "undefined" != typeof c[d].textContent &&
                  0 === c[d].textContent.replace(/\u200B/gi, "").length &&
                  C(c[d]).remove();
              if (
                !(
                  e.which >= S.KEYCODE.ARROW_LEFT &&
                  e.which <= S.KEYCODE.ARROW_DOWN
                )
              ) {
                var o = i();
                m.node.hasClass(o, "fr-emoticon-img") &&
                  (C(o).append(S.MARKERS), m.selection.restore());
              }
            });
        },
        insert: function t(e, c) {
          ...
          d
            ? (0 === o.startOffset && m.selection.element() === d
                ? C(d).before(S.MARKERS + S.INVISIBLE_SPACE)
                : 0 < o.startOffset &&
                  m.selection.element() === d &&
                  o.commonAncestorContainer.parentNode.classList.contains(
                    "fr-emoticon"
                  ) &&
                  C(d).after(S.INVISIBLE_SPACE + S.MARKERS),
              m.selection.restore(),
              m.html.insert(
                '<span class="fr-emoticon fr-deletable'
                  .concat(c ? " fr-emoticon-img" : "", '"')
                  .concat(
                    c ? ' style="background: url('.concat(c, ');"') : "",
                    ">"
                  )
                  .concat(c ? "&nbsp;" : e, "</span>&nbsp;")
                  .concat(S.MARKERS),
          ...
          if (
            (e ||
              (e = (function s() {
                ...
                var e = { buttons: f, custom_layer: n() },
                  ...
                  (function d(h) {
                    m.events.on(
                      ...
                      function (e) {
                        ...
                        if (S.KEYCODE.TAB == s) {
                          if (
                            (c.is("span.fr-emoticon") && e.shiftKey) ||
                            (c.is("a") && !e.shiftKey)
                          ) {
                          ...
                          if (!1 !== d) {
                            ...
                            c.is("span.fr-emoticon") &&
                              (i = i.not("span.fr-emoticon:not(:focus)")),
                              (o = i.index(c)),
                              (o = e.shiftKey
                                ? (((o - 1) % i.length) + i.length) % i.length
                                : (o + 1) % i.length),
                              (a = i.get(o)),
                          ...
                          S.KEYCODE.ARROW_UP == s ||
                          S.KEYCODE.ARROW_DOWN == s ||
                          S.KEYCODE.ARROW_LEFT == s ||
                          S.KEYCODE.ARROW_RIGHT == s
                        ) {
                          if (c.is("span.fr-emoticon")) {
                            ...
                            S.KEYCODE.ARROW_UP == s
                              ...
                              : S.KEYCODE.ARROW_LEFT == s
                              ? (g = (((g - 1) % u) + u) % u)
                              : S.KEYCODE.ARROW_RIGHT == s && (g = (g + 1) % u),
                              (a = C(n.get(g))),
                              m.events.disableBlur(),
                              a.focus(),
                              (d = !1);
                          ...
                          S.KEYCODE.ENTER == s &&
                            (c.is("a") ? c[0].click() : m.button.exec(c),
                            (d = !1));
                        return (
                          !1 === d && (e.preventDefault(), e.stopPropagation()),
                          d
                        );
                      },
                      !0
    ...
    S.DefineIcon("emoticonsBack", { NAME: "arrow-left", SVG_KEY: "back" }),
